...
// Usage: start casperjs --ignore-ssl-errors=true --ssl-protocol=any do_mmhtp_prog.js [OPD_Time]
// Note: MacKay Memorial Hospital Module
		...
		casper.then(function(){
			...
			this.then(function(){
				...
				for(var k=1; k<table_tr.length; k++){
					...
					if((_name=="Unknown") ||(_c_num=="") || (_c_num==0) || (_c_num=="NA")|| (_dep=="銀髮整合")|| (_dep=="健兒門診") ){
