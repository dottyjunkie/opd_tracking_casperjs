...
// By Module Variables
var param = {
  url: "http://www.csh.org.tw/register/VRProgressE.aspx",
  fn_log: "csh_e.json",
  post_url: "http://localhost/opdtrack/engine_debug.php",
  hosname: "中山醫學大學附設醫院中興院區",
  module: "csh_e",
        ...
        return($("#ctl00_ContentPlaceHolder1_DataList3").length>0);
          ...
          if ($("#ctl00_ContentPlaceHolder1_DataList3").find("a").eq(j).attr('href')!=undefined) {
            this.then(function(){
              ...
              var doc_name = $("#ctl00_ContentPlaceHolder1_lDrName").text().replace(/內科醫師/,"");
              var _ampm = $("#ctl00_ContentPlaceHolder1_lApn").text();
              var _p_num = $('td[bgcolor="#D4D4D4"]').length;
