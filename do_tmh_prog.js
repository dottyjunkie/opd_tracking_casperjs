...
// By Module Variables
var param = {
  url: "https://www.tmh.org.tw/TMH2016/RegProgress.aspx?Kind=2",
  fn_log: "tmh.json",
...
function parse(url, dep,grp) {
  return (function() {
    casper.thenOpen("https://www.tmh.org.tw/TMH2016/" + url).then(function() {
      ...
      for (var i = 0; i < tbl_dom.length; i++) {
        ...
        if((doc_name=='醫師未定')||(!_p_num) || (doc_name.indexOf('醫師')>0)){
